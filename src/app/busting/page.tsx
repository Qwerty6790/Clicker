...
export default function busting () {
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="Cards">
        <div>
        <h4 className="main-name"><a href='/earn' className="link">Майнинг </a></h4>
       </div>
        <h4  className="main-name"><a href="/busting">Бустеры</a></h4>
         <h2 className='hero-title'>Покупай улучшение прокачивайся зарабатывай </h2>
         <h3 className='hero-main-title'>Бесплатные ежедневные усилители</h3>
         ...
         <img className='img-6' 
          ...
          width={100}
          />
          <p className='boxing-one'>Полный запас энерегии</p>
          <div className='box-title'>
           <p className='box-list'>0 ур.</p>
          </div>
          <div className='boxing-span'>
            <p className='boxing-two'>5 из 5</p>
